        ...
        <div className="relative z-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="flex-1">
              ...
              >
                Your career journey continues. Let us achieve something
                extraordinary.
              </motion.p>
          ...
          <div className="flex justify-between px-1">
            {sidebarItems.slice(0, 5).map((item) => (
              <motion.button
                ...
                onClick={() => setActiveSection(item.id)}
                whileTap={{ scale: 0.96 }}
                className={`px-2 py-1 rounded-md transition-all duration-150 flex flex-col items-center gap-0 w-14
          ${
            activeSection === item.id
              ...
              >
                ...
                <span className="text-[10px] leading-none mt-0.5 font-semibold">
                  {item.label}
                </span>
                ...
                {activeSection === item.id && (
                  <motion.div
                    ...
                    className="h-0.5 w-3 bg-indigo-600 dark:bg-indigo-400 rounded-full mt-0.5"
                  />
                )}
              </motion.button>
            ))}
